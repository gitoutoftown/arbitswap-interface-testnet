...
export const LOCKER_ADDRESS: AddressMap = {
  [ChainId.ROPSTEN]: '',
  [ChainId.BSC]: '',
  [ChainId.ARBITRUM_SEPOLIA]: '0xA9Ead5d7C9D0B59A2900824A125F3913009fD638',
}

export const ASWAP_DISTRIBUTOR_ADDRESS: AddressMap = {
  [ChainId.ROPSTEN]: '',
  [ChainId.BSC]: '',
  [ChainId.ARBITRUM_SEPOLIA]: '0xf03b75831397D4695a6b9dDdEEA0E578faa30907',
}

export const ASWAP_VAULT_ADDRESS: AddressMap = {
  [ChainId.ARBITRUM_SEPOLIA]: '0x7e6E03822D0077F3C417D33caeAc900Fc2645679',
}

export const ASWAP_ARB_PAIR: AddressMap = {
  [ChainId.ROPSTEN]: '',
  [ChainId.BSC]: '',
  [ChainId.ARBITRUM_SEPOLIA]: '0x7eDA899b3522683636746a2f3a7814e6fFca75e1',
}

export const ARB_USDC_PAIR: AddressMap = {
  [ChainId.ROPSTEN]: '',
  [ChainId.BSC]: '',
  [ChainId.ARBITRUM_SEPOLIA]: '0xe537f70a8b62204832B8Ba91940B77d3f79AEb81',
}

export const RIB_ARB_PAIR: AddressMap = {
  [ChainId.ROPSTEN]: '',
  [ChainId.BSC]: '',
  [ChainId.ARBITRUM_SEPOLIA]: '0x0acDB54E610dAbC82b8FA454b21AD425ae460DF9',
}
...
export const MULTICALL2_ADDRESS: AddressMap = {
  ...
  [ChainId.ARBITRUM_SEPOLIA]: '0x43D002a2B468F048028Ea9C2D3eD4705a94e68Ae',
...
export const WETH9: AddressMap = {
  ...
  [ChainId.BSC_TESTNET]: '',
  [ChainId.MOONBEAM_TESTNET]: '',
  [ChainId.ARBITRUM_SEPOLIA]: '0x98878B06940aE243284CA214f92Bb71a2b032B8A',
  [ChainId.AVALANCHE]: '',
  [ChainId.AVALANCHE_TESTNET]: '',
  [ChainId.HECO]: '',
  [ChainId.HECO_TESTNET]: '',
