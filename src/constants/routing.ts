...
const WRAPPED_NATIVE_ONLY: ChainTokenList = {
  ...
  [ChainId.ARBITCHAIN_SEPOLIA]: [WNATIVE[ChainId.ARBITCHAIN_SEPOLIA]],
}
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.ARBITCHAIN_SEPOLIA]: [...WRAPPED_NATIVE_ONLY[ChainId.ARBITCHAIN_SEPOLIA], ARBITCHAIN_SEPOLIA.DAI, ARBITCHAIN_SEPOLIA.USDC, ARBITCHAIN_SEPOLIA.ASWAP, ARBITCHAIN_SEPOLIA.BUSD],
}
