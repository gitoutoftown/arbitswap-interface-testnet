...
import { ASWAP_DISTRIBUTOR_ADDRESS, MINICHEF_ADDRESS } from '../../constants/addresses'
...
const FarmListItem = ({ farm }) => {
  ...
  const [approvalState, approve] = useApproveCallback(typedDepositValue, ASWAP_DISTRIBUTOR_ADDRESS[chainId])
                ...
                <Button
                  ...
                  onClick={() => {
                    if (!balance.equalTo(ZERO)) {
                      if (liquidityToken?.symbol == 'ASWAP') {
                        try {
